sap.ui.define(["sap/ui/core/mvc/Controller"], function(BaseController) {
	...
	return BaseController.extend("generated.app.controller.1467712000926_S1", {

		onInit: function() {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getTarget("1467712000926_S1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		_onPressSapResponsivePage0footersapmBar1contentRightsapmButton2: function() {
			var oBindingContext = this.getView().getBindingContext();

			this.doNavigate("1467710750930_S0", oBindingContext);
