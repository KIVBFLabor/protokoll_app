sap.ui.define(["sap/ui/core/mvc/Controller"], function(BaseController) {
	...
	return BaseController.extend("generated.app.controller.1467718759783_S2", {

		onInit: function() {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getTarget("1467718759783_S2").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		_onPressSapResponsivePage0footersapmBar1contentRightsapmButton1: function() {
			...
			this.doNavigate("1467712000926_S1", oBindingContext);
